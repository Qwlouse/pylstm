...
from pylstm.regularization.initializer import Gaussian, SparseInputs, Initializer
...
class InitializerTest(unittest.TestCase):
    ...
    def test_create_initializer_from_plain_number(self):
        self.assertEqual(create_object_from_description(0.0), 0.0)
        self.assertEqual(create_object_from_description(1.0), 1.0)
        self.assertEqual(create_object_from_description(5), 5)

    def test_create_initializer_from_list(self):
        self.assertListEqual(create_object_from_description([1]), [1])
        self.assertListEqual(create_object_from_description([1, 2, 3]), [1, 2, 3])
        self.assertListEqual(create_object_from_description([1.0, -1.0]), [1.0, -1.0])
    ...
    def test_create_gaussian_initializer_from_dict(self):
        ...
        init = create_object_from_description(description)
    ...
    def test_custom_initializer(self):
        ...
        c2 = create_object_from_description(descr)
