...
from pylstm.regularization.initializer import (create_initializer, Gaussian,
...
class InitializerTest(unittest.TestCase):
    ...
    def test_create_initializer_from_plain_number(self):
        self.assertEqual(create_initializer(0.0), 0.0)
        self.assertEqual(create_initializer(1.0), 1.0)
        self.assertEqual(create_initializer(5), 5)

    def test_create_initializer_from_list(self):
        self.assertListEqual(create_initializer([1]), [1])
        self.assertListEqual(create_initializer([1, 2, 3]), [1, 2, 3])
        self.assertListEqual(create_initializer([1.0, -1.0]), [1.0, -1.0])
    ...
    def test_create_gaussian_initializer_from_dict(self):
        ...
        init = create_initializer(description)
